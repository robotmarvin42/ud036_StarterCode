...
#This class provides variable for the movie class, and demonstrates nested classes.
...
class Video():
    ...
    # Append comments to comment field. Functionality to be added to website at later time.
